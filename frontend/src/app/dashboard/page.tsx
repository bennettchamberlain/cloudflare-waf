...
const mockData = {
  ...
  stats: {
    ...
    bandwidthSaved: 8.7,
    dailyStats: [
      { date: '2024-01-01', requests: 6800, blocked: 1200, saved: 12.50 },
      { date: '2024-01-02', requests: 7200, blocked: 1850, saved: 18.30 },
      { date: '2024-01-03', requests: 6500, blocked: 1650, saved: 16.20 },
      { date: '2024-01-04', requests: 8100, blocked: 2100, saved: 21.00 },
      { date: '2024-01-05', requests: 7800, blocked: 1990, saved: 19.80 },
      { date: '2024-01-06', requests: 6900, blocked: 1780, saved: 17.60 },
      { date: '2024-01-07', requests: 7300, blocked: 1820, saved: 18.40 }
    ]
  }
};
...
export default function DashboardPage() {
  ...
  const projectedMonthlySavings = data.stats.moneySaved * 4.33; // ~4.33 weeks per month
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">
                ${(data.stats.moneySaved + liveStats.currentSaved).toFixed(2)}
              </div>
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-red-50 to-pink-50">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-600">
                {(data.stats.blockedRequests + liveStats.currentBlocked).toLocaleString()}
              </div>
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-blue-50 to-cyan-50">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">
                {(data.stats.totalRequests + liveStats.currentRequests).toLocaleString()}
              </div>
              <p className="text-xs text-blue-600 mt-1">
                +{liveStats.currentRequests} today
              </p>
              <p className="text-xs text-blue-600/70 mt-1">
                {data.stats.bandwidthSaved.toFixed(1)} GB saved
              </p>
            </CardContent>
          ...
          <Card className="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-purple-50 to-indigo-50">
            ...
            <CardContent>
              ...
              <p className="text-xs text-purple-600 mt-1">
                Since {data.deployedAt.toLocaleDateString()}
              </p>
              <p className="text-xs text-purple-600/70 mt-1">
                {Math.floor((Date.now() - data.deployedAt.getTime()) / (1000 * 60 * 60 * 24))} days protected
              </p>
            </CardContent>
          ...
          <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <AreaChart data={data.stats.dailyStats}>
